...
(function() {
	...
	var libFlyweight, version = Prototype.Version.split('.'), mouseEnterSupported = (parseInt(
			version[0], 10) >= 2)
			|| (parseInt(version[1], 10) >= 7)
			|| (parseInt(version[2], 10) >= 1), mouseCache = {}, elContains = function(
			parent, child) {
	...
	Ext.lib.Dom = {
		...
		setXY : function(el, xy) { // this initially used
									// Position.cumulativeOffset but it is not
									// accurate enough
	...
	Ext.lib.Event = {
		...
		un : function(el, eventName, fn) {
			if ((eventName == 'mouseenter' || eventName == 'mouseleave')
					&& !mouseEnterSupported) {
				var item = mouseCache[el.id], ev = item && item[eventName];
			...
			request : function(method, uri, cb, data, options) {
				...
				if (options) {
					...
					if (options.jsonData) {
						...
						o.postBody = typeof options.jsonData == 'object' ? Ext
