...
<html>
	...
	<body>
		<div style="position: absolute;left: 0mm;top: 0mm;background-image: url('img/kdd/type2.jpg');width: 239mm;height: 135mm;background-repeat: no-repeat;"></div>
		<!--寄件人单位-->
		<div style="position:absolute; left:25mm; top:45mm;"><%=jijianren_danwei%></div>
		<!--寄件人地址-->
		<div style="position:absolute; left:25mm; top:50mm;"><%=jijianren_dizhi%></div>
		<!--寄件人电话-->
		<div style="position:absolute; left:25mm; top:55mm;"><%=jijianren_shouji%></div>
		<!--寄件人邮编-->
		<div style="position:absolute; left:90mm; top:68mm;"><%=jijianren_youbian%></div>
		...
		<!--收件人姓名-->
		<div style="position:absolute; left:117mm; top:40mm;font-size: <%=sjr_font%>;"><%=shoujianren_xingming%></div>
		<!--收件人电话-->
