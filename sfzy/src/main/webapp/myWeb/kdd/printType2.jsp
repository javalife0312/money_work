...
<body onload="printWB();saveKdd();">
	<!--寄件人单位-->
	<div style="position:absolute; left:<%=(type23_jjr_danwei_x+20) %>mm; top:<%=(type23_jjr_danwei_y+25) %>mm;"><%=jijianren_danwei%></div>
	<!--寄件人地址-->
	<div style="position:absolute; left:<%=(type23_jjr_dizhi_x+20) %>mm; top:<%=(type23_jjr_dizhi_y+30) %>mm;"><%=jijianren_dizhi%></div>
	<!--寄件人电话-->
	<div style="position:absolute; left:<%=(type23_jjr_shouji_x+20) %>mm; top:<%=(type23_jjr_shouji_y+35) %>mm;"><%=jijianren_shouji%></div>
	<!--寄件人邮编-->
	<div style="position:absolute; left:<%=(type23_jjr_youbian_x+85) %>mm; top:<%=(type23_jjr_youbian_y+58) %>mm;"><%=""%></div>
	
	
	<!--邮件日期-->
	<div style="position:absolute; left:<%=(type23_jjr_riqi_x+70) %>mm; top:<%=(type23_jjr_riqi_y+8) %>mm;"><%= new Date().toLocaleString() %></div>
	<!--寄件人邮编-->
	<div style="position:absolute; left:<%=(type23_jjr_youbian_x+85) %>mm; top:<%=(type23_jjr_youbian_x+61) %>mm;"><%=jijianren_youbian%></div>
	<!--文书名称-->
