...
-- Table structure for `sjsfy_kelu_userinfo`
-- ----------------------------
DROP TABLE IF EXISTS `sjsfy_device_camera`;
CREATE TABLE `sjsfy_device_camera` (
  `sjs_code` varchar(255) NOT NULL DEFAULT '',
  `sjs_name` varchar(255) DEFAULT '',
  `sjs_deviceGroupCode` varchar(255) DEFAULT '',
  `sjs_parentCode` varchar(255) DEFAULT '',
  `sjs_domainCode` varchar(255) DEFAULT '',
  `sjs_deviceModelType` varchar(255) DEFAULT '',
  `sjs_deviceFormType` int(11) DEFAULT 0,
  `sjs_type` int(11) DEFAULT 0,
  `sjs_cameraLocation` varchar(255) DEFAULT '',
  `sjs_cameraStatus` int(11) DEFAULT 0,
  `sjs_status` int(11) DEFAULT 0,
  `sjs_netType` int(11) DEFAULT 0,
  `sjs_isSupportIntelligent` int(11) DEFAULT 0,
  `sjs_enableVoice` int(11) DEFAULT 0,
  `sjs_nvrCode` varchar(255) DEFAULT '',
  `sjs_deviceCreateTime` VARCHAR (255) DEFAULT '',
  `sjs_isExDomain` int(11) DEFAULT 0,
  `sjs_deviceIP` VARCHAR (255) DEFAULT '',
  `sjs_reserve` VARCHAR (255) DEFAULT '',
  PRIMARY KEY (`sjs_deviceIP`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
